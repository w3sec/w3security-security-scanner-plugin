...
import org.w3security.plugins.workflow.steps.*;
...
public class W3SecuritySecurityStep extends Step implements W3SecurityConfig {
  ...
  public static class Execution
    ...
    public Execution(
      @Nonnull W3SecurityConfig config,
    ...
    protected Void run()
      ...
      W3SecurityStepFlow.perform(
        config,
        () -> W3SecurityContext.forPipelineProject(getContext())
      );
      return null;
    }
  }
  ...
  public static class W3SecuritySecurityStepDescriptor extends StepDescriptor {
    ...
    public ListBoxModel doFillW3SecurityTokenIdItems(
      ...
      return builderDescriptor.doFillW3SecurityTokenIdItems(
        item,
        w3securityTokenId
      );
    }
    ...
    public FormValidation doCheckProjectName(
      ...
      return builderDescriptor.doCheckProjectName(
        value,
