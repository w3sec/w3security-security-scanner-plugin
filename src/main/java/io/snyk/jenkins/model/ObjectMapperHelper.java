...
public class ObjectMapperHelper {
  ...
  public static W3SecurityTestResult unmarshallTestResult(String content)
    throws IOException {
  ...
  private static W3SecurityTestResult readTestResult(JsonParser parser)
    throws IOException {
  ...
  private static W3SecurityTestResult aggregateTestResults(
    List<W3SecurityTestResult> testResults
  ) {
    ...
    testResults.forEach(entity -> {
      ...
      aggregatedTestResult.error =
        (entity.error != null && !entity.error.isEmpty())
