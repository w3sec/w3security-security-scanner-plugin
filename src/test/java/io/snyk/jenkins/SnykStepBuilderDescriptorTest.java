...
public class W3SecurityStepBuilderDescriptorTest {
  ...
  public void doFillSeverityItems_shouldReturnAllValuesFromSeverityEnum() {
    ...
    assertThat(
      model,
      hasItems(
        Severity.LOW.getSeverity(),
        Severity.MEDIUM.getSeverity(),
        Severity.HIGH.getSeverity(),
  ...
  public void doFillW3SecurityTokenIdItems_shouldAddCurrentValue_ifPresent() {
    ListBoxModel model = instance.doFillW3SecurityTokenIdItems(
      null,
      "current-value"
    );
  ...
  public void doCheckSeverity_shouldReturnWarning_ifProjectNameOverriddenWithAdditionalArguments() {
    Kind severityValidation = instance.doCheckSeverity(
      "high",
  ...
  @Test
  public void doCheckW3SecurityTokenId_shouldReturnWarning_ifW3SecurityTokenIsEmpty()
    throws Exception {
    jenkins.createFreeStyleProject();
    Kind w3securityTokenIdValidation = instance.doCheckW3SecurityTokenId(
      jenkins.getInstance().getItems().get(0),
      null
    )
      .kind;
  ...
  @Test
  public void doCheckW3SecurityTokenId_shouldReturnOK_ifW3SecurityTokenFound()
    throws Exception {
    DefaultW3SecurityApiToken w3securityToken = new DefaultW3SecurityApiToken(
    ...
    CredentialsProvider
      .lookupStores(jenkins.getInstance())
      .iterator()
      .next()
      .addCredentials(Domain.global(), w3securityToken);
  ...
  public void doCheckTargetFile_shouldReturnWarning_ifTargetFileOverriddenWithAdditionalArguments() {
    Kind targetFileValidation = instance.doCheckTargetFile(
      "pom.xml",
      "--file=pom-extended.xml"
    )
      .kind;
  ...
  public void doCheckOrganisation_shouldReturnWarning_ifTargetFileOverriddenWithAdditionalArguments() {
    Kind organisationValidation = instance.doCheckOrganisation(
      "w3security",
      "--org=W3Security Ltd"
    )
      .kind;
  ...
  public void doCheckProjectName_shouldAggregateWarningMessages() {
    FormValidation projectNameValidation = instance.doCheckProjectName(
      "project-name",
      "false",
  ...
  public void doCheckProjectName_shouldReturnWarning_ifProjectNameDefinedWithoutMonitorOnBuild() {
    Kind projectNameValidation = instance.doCheckProjectName(
      "project-name",
      "false",
      ""
    )
