...
public class ObjectMapperHelperTest {
  ...
  public static void setupAll() throws Exception {
    URL testDirectoryUrl =
      ObjectMapperHelper.class.getClassLoader().getResource("./fixtures");
    TEST_FIXTURES_DIRECTORY =
      new File(requireNonNull(testDirectoryUrl).toURI());
  }

  @Test
  public void unmarshallTestResult_singleModule_withVulns() throws IOException {
    Path testReportPath = Paths.get(
      TEST_FIXTURES_DIRECTORY.getAbsolutePath(),
      "test",
    ...
    W3SecurityTestResult w3securityTestResult = ObjectMapperHelper.unmarshallTestResult(
      testReport
    );
  ...
  @Test
  public void unmarshallTestResult_singleModule_withoutVulns()
    throws IOException {
    Path testReportPath = Paths.get(
      TEST_FIXTURES_DIRECTORY.getAbsolutePath(),
      "test",
  ...
  @Test
  public void unmarshallTestResult_multiModule_withoutVulns()
    throws IOException {
    Path testReportPath = Paths.get(
      TEST_FIXTURES_DIRECTORY.getAbsolutePath(),
      "test",
